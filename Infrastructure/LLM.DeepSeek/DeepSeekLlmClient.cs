...
public sealed class DeepSeekLlmClient(HttpClient httpClient, IOptions<DeepSeekSetting> options) : ILlmClient
{
    ...
    public async Task<ChatResponse> ChatAsync(ChatRequest request, CancellationToken cancellationToken = default)
    {
        ...
        if (dto == null)
        {
            throw new InvalidOperationException("DeepSeek response is empty.");
        }
    ...
    private void ValidateSettings()
    {
        ...
        {
            throw new InvalidOperationException("DeepSeek BaseUrl is required.");
        }

        if (string.IsNullOrWhiteSpace(settings.ApiKey))
        {
            throw new InvalidOperationException("DeepSeek ApiKey is required.");
        }
    }
    ...
    private string ResolveModel(ChatRequest request)
    {
        ...
        throw new InvalidOperationException("LLM model is required (request.Model or DeepSeekSetting.DefaultModel).");
    }
