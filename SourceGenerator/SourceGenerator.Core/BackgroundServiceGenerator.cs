...
public sealed class BackgroundServiceGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(collected, static (spc, tuple) =>
        {
            ...
            if (isStartupLike)
            {
                ...
                sb.AppendLine();
                sb.AppendLine("    public static Microsoft.Extensions.DependencyInjection.IServiceCollection BatchRegisterBackgroundServices(this Microsoft.Extensions.DependencyInjection.IServiceCollection services)");
                sb.AppendLine("    {");
    ...
    {
        // 使用 AddHostedService<Impl>(services) 语法注册后台服务
        var sb = new StringBuilder("global::Microsoft.Extensions.DependencyInjection.ServiceCollectionHostedServiceExtensions.AddHostedService");
