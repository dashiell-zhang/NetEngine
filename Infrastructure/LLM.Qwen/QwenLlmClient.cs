...
public sealed class QwenLlmClient(HttpClient httpClient, IOptions<QwenSetting> options) : ILlmClient
{
    ...
    public async Task<ChatResponse> ChatAsync(ChatRequest request, CancellationToken cancellationToken = default)
    {
        ...
        if (dto == null)
        {
            throw new InvalidOperationException("Qwen response is empty.");
        }
    ...
    private void ValidateSettings()
    {
        ...
        {
            throw new InvalidOperationException("Qwen BaseUrl is required.");
        }

        if (string.IsNullOrWhiteSpace(settings.ApiKey))
        {
            throw new InvalidOperationException("Qwen ApiKey is required.");
        }
    }
    ...
    private string ResolveModel(ChatRequest request)
    {
        ...
        throw new InvalidOperationException("LLM model is required (request.Model or QwenSetting.DefaultModel).");
    }
